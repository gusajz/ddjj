...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Jurisdiction.parent'
        db.alter_column(u'ddjjapp_jurisdiction', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddjjapp.Jurisdiction'], null=True))

    def backwards(self, orm):

        # Changing field 'Jurisdiction.parent'
        db.alter_column(u'ddjjapp_jurisdiction', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ddjjapp.Jurisdiction']))
