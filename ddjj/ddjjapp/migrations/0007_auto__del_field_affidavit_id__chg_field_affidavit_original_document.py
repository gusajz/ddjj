...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Affidavit.id'
        db.delete_column(u'ddjjapp_affidavit', u'id')


        # Changing field 'Affidavit.original_document'
        db.alter_column(u'ddjjapp_affidavit', 'original_document_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ddjjapp.Document'], unique=True, primary_key=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Affidavit.id'
        raise RuntimeError("Cannot reverse this migration. 'Affidavit.id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Affidavit.id'
        db.add_column(u'ddjjapp_affidavit', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)


        # Changing field 'Affidavit.original_document'
        db.alter_column(u'ddjjapp_affidavit', 'original_document_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ddjjapp.Document'], unique=True))
    ...
    models = {
        u'ddjjapp.affidavit': {
            ...
            'original_document': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ddjjapp.Document']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'ddjjapp.document': {
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['ddjjapp.AffidavitTemplate']", 'null': 'True', 'blank': 'True'})
        },
