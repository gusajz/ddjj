...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'ddjjapp_document', 'created')

        # Deleting field 'Document.modified'
        db.delete_column(u'ddjjapp_document', 'modified')
