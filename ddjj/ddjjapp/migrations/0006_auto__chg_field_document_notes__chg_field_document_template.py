...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.notes'
        db.alter_column(u'ddjjapp_document', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Document.template'
        db.alter_column(u'ddjjapp_document', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddjjapp.AffidavitTemplate'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Document.notes'
        raise RuntimeError("Cannot reverse this migration. 'Document.notes' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Document.notes'
        db.alter_column(u'ddjjapp_document', 'notes', self.gf('django.db.models.fields.TextField')())

        # User chose to not deal with backwards NULL issues for 'Document.template'
        raise RuntimeError("Cannot reverse this migration. 'Document.template' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Document.template'
        db.alter_column(u'ddjjapp_document', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddjjapp.AffidavitTemplate']))
